...
public:
    ...
    void loadSavedProgress(int learnerId, int &chapter, int answers[5], int &currentQ, int &elapsedTime); // load saved progress
...
private:
    ...
    int resultCount = 0; // Number of results stored
